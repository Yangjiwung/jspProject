...
<!DOCTYPE html><html><head><meta charset="UTF-8">
	...
	function validateForm(form) { // validateForm를 호출하면 form의 매개값을 받는다.
		if(form.title.value == ""){ // 폼에 들어온 제목값을 확인하여 빈칸일 경우 alert창 띄우기
			alert("제목을 입력하세요."); // 경고창과 메세지를 출력
			form.title.focus(); // 제목박스에 커서를 이동한다.
			return false; // 결과로 false값을 리턴한다.
		}
	
		if(form.content.value == ""){/* 폼안에 내용 값을 확인하여 빈칸이면 */
...
<title>Write.jsp</title></head><body>
